...
ActiveRecord::Schema.define(version: 20170717174711) do
  ...
  add_index "reviews", ["home_listing_id"], name: "index_reviews_on_home_listing_id"
  add_index "reviews", ["tenant_id"], name: "index_reviews_on_tenant_id"
